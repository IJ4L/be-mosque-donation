...
import { insertNewsSchema, patchNewsSchema, selectNewsSchema, } from "../../db/schema.js";
const tags = ["News"];
...
export const create = createRoute({
    ...
    responses: {
        ...
        [HttpStatusCodes.UNPROCESSABLE_ENTITY]: jsonContent(z.object({
            message: z.string(),
            data: z.null(),
...
export const getOne = createRoute({
    ...
    responses: {
        ...
        [HttpStatusCodes.UNPROCESSABLE_ENTITY]: jsonContent(createErrorSchema(insertNewsSchema), "The validation error(s)"),
    },
});
