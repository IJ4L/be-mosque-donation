...
export class ValidationUtils {
  ...
  static validateUpdateUserData(userData: UpdateUserData): ValidationResult {
    const errors: string[] = [];
...
export class ResponseUtils {
  static createSuccessResponse<T>(message: string, data: T): AuthResponse<T> {
    return {
      message,
      data,
    };
  ...
  static createErrorResponse(message: string): AuthResponse<null> {
    return {
      message,
      data: null,
    };
  ...
  static createValidationErrorResponse(errors: string[]): AuthResponse<null> {
    return {
      message: errors.join(", "),
      data: null,
    };
...
export class TransformUtils {
  static removePasswordFromUser(user: any): UserWithoutPassword {
  ...
  static sanitizeUpdateUserData(userData: UpdateUserData): UpdateUserData {
    return {
